  ...
  const works = [
    {
      ...
      modalContent: [
        ...
        },
        {
          ...
          description: "It connects to database to store dynamic data, it connects to databse directly from vercel postgress sql server, of course working on it",
    ...
    },
    {
      ...
      modalContent: [
        ...
        },
        {
          id: 2,
          title: "Database connectivity",
          description: "It connects to database to store dynamic data, it connects to databse directly from vercel postgress sql server, of course will work it soon",
          photo: "/works/wo-2/2.jpg",
        },
        {
          id: 3,
          title: "Data fetching",
          description: "Using next powerful feature of server compoenents by querying database directly, it populates data coming from server into UI, of course will work it soon",
     ...
     photo: "/works/wo-6/wall.jpg",
      ...
      modalContent: [
        ...
        },
        {
          id: 3,
          title: "Data fetching",
          description: "Using next powerful feature of server compoenents by querying database directly, it populates data coming from server into UI, of course working on it, of course will work it soon",

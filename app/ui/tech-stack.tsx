      ...
      <div className="mx-auto max-w-screen-xl">
        <div className="grid md:grid-cols-4 grid-cols-3 md:gap-6 gap-1">
          ...
          <div className="flex flex-col items-center justify-center 
           md:rounded-md p-5 hover:bg-blue-50 dark:hover:bg-gray-700 group transition-all duration-700 ease-in-out">
            <div className="flex items-center justify-center rounded-full w-20 h-20 dark:bg-gray-600">
          ...
          <div className="flex flex-col items-center justify-center 
           rounded-lg p-5 hover:bg-blue-50 dark:hover:bg-gray-700 group transition-all duration-500 ease-out">
            <div className="flex items-center justify-center bg-slate-100 rounded-full w-20 h-20 dark:bg-gray-600">

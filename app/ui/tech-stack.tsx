      ...
      <div className="mx-auto max-w-screen-xl">
        <div className="grid md:grid-cols-4 grid-cols-3 md:gap-6 gap-1">
          ...
          <div className="flex flex-col items-center justify-center group md:hover:-translate-y-1 transition-all duration-700 ease-in-out">
            <div className="md:w-40 md:h-40 w-20 h-20 rounded-full group-hover:bg-blue-50 transition-all duration-500 ease-in-out flex items-center justify-center dark:group-hover:bg-gray-50/5">
